...
const projects = [
...

    {
        ...
        tags: ["React.js", "Next.js", "Tailwind.css", "Typescript", "Google Gemini API", "Vapi Voice agent", "Firebase"],
        demoURL: "#",
    ...
    return (
        <section id="projects" ref={ref} className="py-24 px-4 relative">
            <div className="container mx-auto max-w-5xl">
                <h2 className={`text-3xl md:text-4xl font-bold mb-4 texxt-center opacity-0 ${inView ? "animate-fade-in-up" : ""}`}>
                    Featured <span className="text-primary"> Projects </span>
                </h2>

                <p className={`text-center text-muted-foreground mb-12 max-w-2xl mx-auto opacity-0 ${inView ? "animate-fade-in-up-delay-1" : ""}`}>
                    Below are some of my featured projects that I've worked on. You can click on the images.
                </p>

                <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 opacity-0 ${inView ? "animate-fade-in-up-delay-2" : ""}`}>

                    {projects.map((project, key) => (
                        <div key={key} className="group bg-card rounded-lg overflow-hidden tshadow-xs card-hover">
                            <div className="h-48 overflow-hidden opacity-0 animate-fade-in">
                                <img 
                                    src={project.image} 
                                    alt={project.title} 
                            ...
                            <div className="p-6">
                                <div className="flex flex-wrap gap-2 mb-4 opacity-0 animate-fade-in-delay-1">
                                ...
                                <h3 className="text-xl mb-1 font-semibold opacity-0 animate-fade-in-delay-2">{project.title}</h3>
                                <p className="text-muted-foreground text-sm mb-4 opacity-0 animate-fade-in-delay-3">
                                    {project.description}
                                </p>

                                <div className="flex justify-between items-center opacity-0 animate-fade-in-delay-4">
